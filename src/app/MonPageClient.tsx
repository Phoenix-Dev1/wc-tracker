...
// Helper to format city names cleanly
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6" data-aos="fade-right">
            ...
            <div className="bg-bg-700/60 backdrop-blur-sm border border-border/50 p-1 rounded-full inline-flex shadow-sm text-xs font-semibold select-none self-start md:self-auto">
              <button
                ...
                className={`px-4 py-1.5 rounded-full font-bold transition-all duration-200 flex items-center gap-1.5 ${viewMode === "SCHEDULE"
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-full font-bold transition-all duration-200 flex items-center gap-1.5 ${viewMode === "ANALYSIS"
                  ? "bg-bg-800 shadow-sm text-text-primary"
                  : "text-text-secondary hover:text-text-primary"
                  }`}
              >
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div className="flex bg-bg-900 border border-border rounded-xl p-1 text-xs">
                      {["LIVE", "UPCOMING", "COMPLETED"].map((status) => (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-lg font-medium transition-all ${selectedStatus === status
                    ...
                    <div className="flex bg-bg-900 border border-border rounded-xl p-1 text-xs">
                      <button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-medium transition-all ${groupingMode === "date"
                      ...
                      <button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-medium transition-all ${groupingMode === "group"
                          ? "bg-purple-600 text-white font-semibold shadow-sm shadow-purple-600/10"
                          : "text-text-secondary hover:text-text-primary"
                          }`}
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl border text-xs font-semibold transition-all ${isFilterExpanded || selectedStage !== "ALL" || selectedGroup !== "ALL"
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          <div className="grid grid-cols-3 gap-2 bg-bg-900 p-1 border border-border rounded-xl text-xs">
                            {[
                              ...
                              <button
                                ...
                                className={`py-1.5 rounded-lg font-medium transition-all ${selectedStage === stage.id
                        ...
                        <div className="flex flex-col gap-1.5">
                          ...
                          <select
                            ...
                            className="bg-bg-900 border border-border text-text-primary text-xs rounded-xl p-2 focus:border-cyan-500 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed transition-all"
                          >
                      ...
                      {(selectedStage !== "ALL" || selectedGroup !== "ALL" || searchQuery !== "" || selectedStatus !== "UPCOMING") && (
                        <div className="flex justify-end mt-4">
                          <button
                            ...
                            className="text-xs text-rose-600 hover:text-rose-700 transition-colors underline font-medium"
                          >
                            Reset All Filters
                          </button>
                        </div>
